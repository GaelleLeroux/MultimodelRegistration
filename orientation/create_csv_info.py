...
if __name__=="__main__":
    ...
    parser.add_argument('--input', type=str, default='/home/luciacev/Documents/Gaelle/Data/MultimodelReg/Orientation_test/direction/', help='Input folder')
    parser.add_argument('--output', type=str, default='/home/luciacev/Documents/Gaelle/Data/MultimodelReg/Orientation_test', help='Output directory for the aggregated CSV file')
    parser.add_argument('--name', type=str, default='image_info_direction_changed.csv', help='name of the CSV')
