...
def main(args):
    ...
    for cbct_file in os.listdir(cbct_folder):
        if cbct_file.endswith(".nii.gz") and "_CBCT_" in cbct_file:
            ...
            process_images(cbct_path, mri_path, cbct_mask_path, mri_mask_path, cbct_seg_path, mri_seg_path, output_folder,patient_id)

def process_images(fixed_image_path, moving_image_path, fixed_mask_path, moving_mask_path, fixed_seg_path, moving_seg_path, output_folder, patient_id):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cbct_mask_folder", type=str, help="Folder containing CBCT masks.", default="/home/lucia/Documents/Gaelle/Data/MultimodelReg/Segmentation/Registration/b5_folder_CBCT_mask/test")
    ...
    parser.add_argument("--mri_folder", type=str,  help="Folder containing MRI images.", default="/home/lucia/Documents/Gaelle/Data/MultimodelReg/Segmentation/Registration/a2_folder_MRI/test")
    ...
    parser.add_argument("--output_folder", type=str,  help="Folder to save the output files.",default="/home/lucia/Documents/Gaelle/Data/MultimodelReg/Segmentation/Registration/z1_test/a02_normal_mri+cbct_normal")
